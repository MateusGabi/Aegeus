...
public class Operation {
    ...
    public String toString() {
        return name + "\n" +
                "params=" + paramList.stream().map(param -> param.getName() + ":" + param.getType()).collect(Collectors.toList()) + "\n" +
                "output=" + responseType + "\n" +
                "using-types=" + usingTypesList.stream().distinct().collect(Collectors.toList()) + "\n";
